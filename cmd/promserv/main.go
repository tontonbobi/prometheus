...
func Main() int {
	...
	if cfg.opentsdbURL == "" && cfg.influxURL == "" {
		...
		if cfg.influxURL != "" {
			addRemoteStorage(influxdb.NewClient(cfg.influxURL, cfg.remoteStorageTimeout, cfg.influxDatabase, cfg.influxRetentionPolicy))
		}
